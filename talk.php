...
<head>
    ...
    <style type="text/css">
        ...
        ul#messages li small { display: block; font-size: 1.0em; color: #888888; }
        ul#messages li.pending { color: #888888; }
...
<form action="<?= htmlentities($_SERVER['PHP_SELF'], ENT_COMPAT, 'UTF-8'); ?>" method="post">
    <p>
        <input type="text" name="content" id="content" maxlength="500" placeholder="შეტყობინება.."/><button type="submit"> დაწერა </button>
    </p>
    <p>
        <label>
            <input type="hidden" name="name" id="name" maxlength="50" value="<?php echo $name; ?>" placeholder="მომხმარებელი" />
        </label>
