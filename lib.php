...
<center><details>
    <summary>ანკეტის რედაქტირება</summary><br>\n";
}
if($s_pass==""){
...
$output.="<input type=hidden name=login value=\"".addslashes($s_login)."\"><input type=hidden name=pass value=\"".addslashes($s_pass)."\"></div>\n";
}
...
$output.="<a href=foto.php?".$s_foto." target=_blank>ფოტო</a>: ";
}
...
$output.="<input type=submit name=submit value=დამახსოვრება!></div>
</table>
</form>
